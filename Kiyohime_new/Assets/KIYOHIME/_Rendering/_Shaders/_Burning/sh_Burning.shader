...
Shader "s_burning"
{
	Properties
	{
		...
		_tiling_tex("tiling_tex", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_TexCoord36 = v.texcoord.xy * _tiling_tex;
			float2 panner35 = ( temp_output_12_0 * float2( 0,-1 ) + uv_TexCoord36);
			float3 tex2DNode31 = UnpackNormal( SAMPLE_TEXTURE2D_LOD( _Distorsion_map, sampler_Distorsion_map, panner35, 0.0 ) );
			float2 uv_TexCoord40 = v.texcoord.xy * _tiling_tex;
			float4 tex2DNode21 = SAMPLE_TEXTURE2D_LOD( _Mask, sampler_Mask, ( ( (tex2DNode31).xy * _heat_wave ) + uv_TexCoord40 ), 0.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord36 = i.uv_texcoord * _tiling_tex;
			float2 panner35 = ( temp_output_12_0 * float2( 0,-1 ) + uv_TexCoord36);
			float3 tex2DNode31 = UnpackNormal( SAMPLE_TEXTURE2D( _Distorsion_map, sampler_Distorsion_map, panner35 ) );
			float2 uv_TexCoord40 = i.uv_texcoord * _tiling_tex;
			float4 tex2DNode21 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, ( ( (tex2DNode31).xy * _heat_wave ) + uv_TexCoord40 ) );
			float temp_output_22_0 = step( tex2DNode21.r , _Burn );
			...
			o.Emission = ( ( ( ( pow( lerpResult16 , temp_cast_1 ) * 2.0 ) * ( temp_output_22_0 + ( temp_output_22_0 - step( tex2DNode21.r , temp_output_27_0 ) ) ) ) - temp_cast_2 ) - temp_cast_3 ).rgb;
...
/*ASEBEGIN
Version=18400
0;0;1920;1019;2384.91;875.8258;1.822855;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;11;-3396.433,284.9196;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-3590.471,595.5016;Inherit;False;Property;_scrol_speed;scrol_speed;5;0;Create;True;0;0;False;0;False;0;0.28;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;59;-3796.246,1304.949;Inherit;False;Property;_tiling_tex;tiling_tex;11;0;Create;True;0;0;False;0;False;0,0;2.2,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;3;-2997.951,-241.7855;Inherit;True;Property;_Distorsion_map;Distorsion_map;3;0;Create;True;0;0;False;0;False;None;e9742c575b8f4644fb9379e7347ff62e;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.PannerNode;10;-2893.101,580.0892;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,-1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-2436.545,1427.256;Inherit;False;Property;_heat_wave;_heat_wave;9;0;Create;True;0;0;False;0;False;0;0.02;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;5;-2370.644,-47.44933;Inherit;True;True;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;6;-2039.197,-4.955458;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;9;-1548.547,431.062;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1329.042,1026.607;Inherit;False;Property;_Burn;_Burn;0;0;Create;True;0;0;False;0;False;0.1856532;0.362;0;1.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;15;-1108.188,-343.4617;Inherit;False;Property;_hot;hot;7;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0.9386859,0.3324516,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;14;-1107.1,-533.1076;Inherit;False;Property;_warm;warm;6;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;1,0.7912982,0.000910581,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-698.6758,-24.87227;Inherit;False;Constant;_Float0;Float 0;8;0;Create;True;0;0;False;0;False;2;0.144;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;941.0759,508.897;Inherit;False;Property;_wiggle_amount;_wiggle_amount;10;0;Create;True;0;0;False;0;False;0;0.0001;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;25;846.9713,-504.2784;Inherit;True;Property;_Albedo;_Albedo;8;0;Create;True;0;0;False;0;False;-1;None;7130c16fd8005b546b111d341310a9a4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;60;-3480.867,1015.866;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5FF8459CAB90FBFEA7783A1E4D41E29B8159D949